...
export const BackgroundBeamsWithCollision = ({ children, className }) => {
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "h-250 sm:h-[51rem] md:h-[51rem] lg:h-[60rem] xl:h-[51rem] bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-800 relative flex items-center w-full justify-center overflow-hidden",
