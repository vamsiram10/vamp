...
const SimpleSparkles = ({ className }) => {
  ...
  return (
    <div
      ...
      style={{
        background:
          "repeating-radial-gradient(circle at 20% 30%, #fff8, #fff8 1px, transparent 2px, transparent 20px), repeating-radial-gradient(circle at 70% 70%, #fff6, #fff6 1.5px, transparent 2.5px, transparent 25px)",
        animation: "sparkle-move 4s linear infinite",
        opacity: 0.2,
      }}
    >
      {/* CSS animation for demo sparkle movement */}
      <style jsx>{`
      ...
      <AnimatePresence>
        {hovered && (
          ...
          >
            ...
            >
              <SimpleSparkles className="w-full h-full" />
              <SimpleSparkles className="w-full h-full" />
            </motion.div>
          </motion.div>
        )}
