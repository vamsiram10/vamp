...
function PortalTransition({ onFinish }) {
  ...
  return (
    <div className="z-[9999] fixed inset-0 flex items-center justify-center bg-black">
      <div className="relative flex items-center justify-center w-full h-full">
        {/* Portal ring */}
        <div className="absolute left-1/2 top-1/2 w-80 h-80 h-[28rem] portal-outer -translate-x-1/2 -translate-y-1/2 sm:w-[28rem]">
          <div className="portal-ring"></div>
        </div>
        {/* Portal glow */}
        <div className="absolute left-1/2 top-1/2 w-60 h-60 h-96 portal-glow -translate-x-1/2 -translate-y-1/2 sm:w-96"></div>
        {/* Center text */}
        <div className="z-10 relative text-center">
          <span className="text-3xl font-extrabold text-blue-300 drop-shadow-lg portal-text sm:text-5xl">
            Opening Portal...
          </span>
        </div>
      </div>
      <style jsx>{`
        .portal-ring {
          ...
          background: conic-gradient(from 0deg, #7c3aed, #38bdf8, #7c3aed 100%);
          box-shadow: 0 0 64px 16px #7c3aed55, 0 0 32px 0 #38bdf855;
          animation: portal-spin 1.5s cubic-bezier(0.6, 1.5, 0.5, 1) forwards;
        }
        .portal-glow {
          border-radius: 50%;
          ...
          filter: blur(32px);
          opacity: 0.7;
          animation: portal-glow-in 1.2s cubic-bezier(0.6, 1.5, 0.5, 1) forwards;
        }
        .portal-text {
          opacity: 0;
          animation: portal-text-in 0.8s 0.4s cubic-bezier(0.6, 1.5, 0.5, 1)
            forwards;
        }
...
const AboutMe = () => {
  ...
  return (
    <>
      {showPortal && <PortalTransition onFinish={() => setShowPortal(false)} />}
      {!showPortal && (
        <>
          <section className="relative top-10 px-4 mx-auto py-12 max-w-3xl">
            ...
            <p className="mx-auto text-lg leading-relaxed text-white text-center">
              ...
              front-end development and modern programming languages. I
              specialize in building interactive, user-focused web applications
              using React.js and the Next.js framework. My experience began with
            ...
            <p className="mx-auto mt-6 text-lg leading-relaxed text-white text-center">
              ...
              ecosystem. This website is a reflection of my skills and
              dedication to modern web development, and I look forward to
              expanding it further as I continue to grow as a React and Next.js
              developer.
            </p>
          </section>
          ...
          <section className="relative px-4 mx-auto py-16 max-w-4xl">
            <h2 className="mb-10 text-4xl font-extrabold text-center text-blue-500">
              <span className="inline-block align-middle">🚀</span> Technical
              Skills
            </h2>
          ...
          <section className="relative px-4 mx-auto py-16 max-w-4xl">
            <h2 className="mb-10 text-4xl font-extrabold text-center text-blue-500">
              <span className="inline-block align-middle">🌐</span> Online
              Presence
            </h2>
