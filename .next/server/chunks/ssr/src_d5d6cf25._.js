...
`;
const DIGIT_LAYOUT = [
    // Each row has 3 cells: [cell0, cell1, cell2] // 7 rows
    [
        // row 0
        {
...
// The digit keys/ids, in render order, alternating with 'sep' separator (colons).
const digitIDs = [
    "h1",
    "h2",
    "sep",
...
// Make a quick helper for extracting the digit-to-render for each slot
...
function DigitalClock() {
    ...
    // Helper to print cell row (for digits)
    function DigitRows({ digit }) {
        return DIGIT_LAYOUT.map((row, rowIdx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: row.map((cell, cellIdx)=>{
                    // If cell is "active cell ..." we should check if digit matches the d# class in the string
                    let classNames = cell.className || "";
                    if (classNames.indexOf("active") >= 0) {
                        // Find d#
                        // Classnames are e.g. "active cell d0 d2 d3 d4 d5 d6 d7 d8 d9"
                        // We only include "active" if the current digit is one of the d# in the list
                        const allowed = classNames.match(/d[0-9]/g) || [];
                        if (allowed.length > 0 && !allowed.includes(`d${digit}`)) {
                            // Not active for this digit
    ...
    // Helper for separator colon (7-row vertical): only 3rd and 5th row active
    function Separator() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(LoaderGallery, {}, void 0, false, {
                    fileName: "[project]/src/components/ui/DigitalClock.jsx",
                    lineNumber: 201,
                    columnNumber: 9
                }, this)
...
const images = [
    "https://lorempixel.com/186/116/nature/1",
    "https://lorempixel.com/186/116/nature/2",
    "https://lorempixel.com/186/116/nature/3",
    "https://lorempixel.com/186/116/nature/4",
    "https://lorempixel.com/186/116/nature/5",
    "https://lorempixel.com/186/116/nature/6",
    "https://lorempixel.com/186/116/nature/7",
    "https://lorempixel.com/186/116/nature/8",
    "https://lorempixel.com/186/116/people/9"
];
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                style: {
                    ...
                    fontSize: "4em",
                    fontWeight: 400,
                    textShadow: "0 1px white, 0 2px black"
                },
                children: "3d images gallery"
            }, void 0, false, {
...
//# sourceMappingURL=src_d5d6cf25._.js.map